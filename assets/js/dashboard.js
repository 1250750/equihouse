    ...
    const payouts = [
      // datas recentes, valores fictícios
    ...
    // ——— KPIs ———
    function renderKPIs(){
      const totalInvest = projetos.reduce((a,b)=>a + b.montante * (b.progresso/100), 0);
    ...
    function drawChart(months=12){
      ...
      canvas.onmousemove = (ev)=>{
        const bx = ev.offsetX, by = ev.offsetY;
        // achar índice mais próximo no eixo x
        let idx = 0, mind = 1e9;
    ...
    function renderTabela(){
      ...
      // KPIs simples
      const total = projetos.reduce((a,b)=>a + b.montante*(b.progresso/100), 0);
    ...
    // tornar o gráfico responsivo ao resize
